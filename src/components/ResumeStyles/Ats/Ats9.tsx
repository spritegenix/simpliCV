      ...
      !!resumeData.projectWorks && resumeData.projectWorks?.length > 0 ? (
        <>
          ...
          {resumeData.projectWorks?.map((item, index) => (
            <div key={index} className="!m-0 break-inside-avoid space-y-1 pt-1">
  ...
  return (
    ...
    >
      <div className="col-span-10 flex h-max flex-col justify-between">
        ...
        {/* Social Links  */}
        <div
          className="grid grid-cols-2 text-[1.2em]"
...
function PersonalInfoHeader1({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex items-end gap-x-3 text-white"
          data-resume-header-title-row
        >
          <p
            className="font-bold"
      ...
      {/* Social Links  */}
      <div
        className="grid grid-cols-3 flex-wrap gap-x-8 gap-y-1 text-sm"
        data-resume-personal-details
      >
        {(city || country) && (
